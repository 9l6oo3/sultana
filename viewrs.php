...
<h3>
	عرض كافة المدارس الحكومية <a href="newViewrs.php" class="btn btn-sm btn-success pull-right"> إضافة مدرسة</a>
...
<table border="0" align="center" id="example" cellpadding="1" class="table table-bordered" style="background-color:#FFF">
 <thead>
  <tr class="active">
    ...
    <th nowrap="nowrap">اسم المدرسة الحكومية</th>
  ...
  <tbody>
	...
	<td nowrap="nowrap"><?php echo $row['viewr_name']; ?></td>
