...
?>
<h4 class="text-center text-muted">اضافة ولي أمر</h4> <a href="index.php?id=<?php  ?>" class="btn btn-primary">عودة</a>
<div class="row">
...
if(isset($_POST['save_button'])) {
	$gu_id =$_POST['gu_id'];
	$gu_name = trim($_POST['name']);
	
	$query1 = "SELECT * FROM tbl_guardians WHERE gu_name = '$gu_name' LIMIT 1";
	...
	$q = "INSERT INTO tbl_guardians VALUES(NULL,'$gu_id','$gu_name')";
	...
	if($res) {
		...
		echo '<meta http-equiv="refresh" content="1;url=guardian.php" />';	
		exit();
	} else {
		echo 'Error Occurred';
	} 
