...
<h3>
	عرض تفاصيل مختلفة <a href="newOthers.php" class="btn btn-sm btn-success pull-right"> اضافة تفاصيل</a>
...
<table border="0" align="center" id="example" cellpadding="1" class="table table-bordered" style="background-color:#FFF">
 <thead>
  <tr class="active">
    ...
    <th nowrap="nowrap">البيانات الإضافية</th>
  ...
  <tbody>
	...
	<td nowrap="nowrap"><?php echo $row['other_name']; ?></td>
