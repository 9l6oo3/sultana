...
?>
<h4 class="text-center text-muted">اضافة دائرة جديدة</h4> <a href="index.php?id=<?php  ?>" class="btn btn-primary">عودة</a>
<div class="row">
...
if(isset($_POST['save_button'])) {
	...
	$query1 = "SELECT * FROM tbl_centers WHERE center_name = '$center_name' LIMIT 1";
	...
	$q = "INSERT INTO tbl_centers VALUES(NULL,'$task_id','$center_name')";
	...
	if($res) {
		...
		echo '<meta http-equiv="refresh" content="1;url=centers.php" />';	
		exit();
	} else {
		echo 'Error Occurred';
	} 
