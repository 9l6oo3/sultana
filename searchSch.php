...
if(isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM tbl_schoolstype,tbl_schools WHERE address LIKE '%$search%' or school_name LIKE '%$search%'OR schoolname LIKE '%$search%'";
	////echo $sql . "<br>";
 ...
 print"
  <table border=\"5\" cellpadding=\"5\" cellspacing=\"0\" style=\"border-  collapse: collapse\" bordercolor=\"#808080\" width=\"100&#37;\"    id=\"AutoNumber2\" bgcolor=\"#C0C0C0\">
   <tr>
<td width=100>تصنيف المدرسة</td> 
  <td width=100>اسم المدرسة</td> 
  <td width=100>الولاية</td> 
  </tr> ";
