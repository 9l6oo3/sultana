...
?>
<h4 class="text-center text-muted"> اضافة بيانات أخرى</h4> <a href="index.php?id=<?php  ?>" class="btn btn-primary">عودة</a>
<div class="row">
...
if(isset($_POST['save_button'])) {
	...
	$other_name = trim($_POST['name']);
	
	$query1 = "SELECT * FROM tbl_others WHERE other_name = '$other_name' LIMIT 1";
	...
	$q = "INSERT INTO tbl_others VALUES(NULL,'$other_id','$other_name')";
	...
	if($res) {
		...
		echo '<meta http-equiv="refresh" content="1;url=others.php" />';	
		exit();
	} else {
		echo 'Error Occurred';
	} 
